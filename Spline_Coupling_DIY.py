...
class SplineCouplingDIY(TransformModule):
    r"""
    ...
    def __init__(self, input_dim, split_dim, hypernet, count_bins=8, bound=3., order='linear', identity=False):
        super(SplineCouplingDIY, self).__init__(cache_size=1)
        ...
        self.linear_layer = nn.Linear(256, input_dim - split_dim)
        
    def _call(self, x, connect_features):
        """
        ...
        upper_spline = self.upper_spline.condition(self.linear_layer(connect_features))
        y2 = upper_spline(x2)
    ...
    def _inverse(self, y, connect_features):
        """
...
def spline_couplingDIY(input_dim, split_dim=None, hidden_dims=None, count_bins=8, bound=3.0):
    """
    ...
    return SplineCouplingDIY(input_dim, split_dim, nn, count_bins, bound)